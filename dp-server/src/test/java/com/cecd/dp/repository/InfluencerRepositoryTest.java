...
public class InfluencerRepositoryTest {
    ...
    public void test0() throws Exception {
        ...
        //when
        List<ProfileProjection> result = influencerRepository.getProfileById(influencerId, PageRequest.of(0, 1));
    ...
    public void test1() throws Exception {
        ...
        //when
        List<MostPostsProjection> result = influencerRepository.getMostThreePostsById(influencerId, PageRequest.of(0, 3));
